...
@section('content')
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
            <h1 class="h2">افزودن اتاق جدید</h1>
        </div>
        ...
        <form action="{{ route('classroom.store') }}" method="post">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" id="class_number" name="class_number" placeholder="نام دانشکده" value="{{ old('class_number') }}">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select  name="building" class="browser-default custom-select">
                        @foreach($buildings as $building)
                            <option value="{{$building->code}}" {{ old('building') == $building->code ? 'selected' : '' }}>{{$building->name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" id="floor" name="floor" placeholder="طبقه" value="{{ old('floor') }}">
                </div>
                <div class="form-group col-md-4">
        ...
        <form action="{{ url('classroom/import') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
